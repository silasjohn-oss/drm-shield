...
Place any PDF in the `uploads/` folder and name it `sample.pdf`.
...
curl -X POST http://localhost:3000/auth/login \
  ...
  -d '{"email":"user@test.com","password":"pass123","deviceHash":"my-device"}'
...
# 3. Open the secureUrl in a browser — watermarked PDF downloads automatically
```
...
│   │   ├── aiService.js           # Featherless AI threat analysis
│   │   └── voiceService.js        # ElevenLabs voice alerts
